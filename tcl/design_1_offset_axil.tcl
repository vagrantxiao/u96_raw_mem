...
# module references:
# axi2axil, axi_offset, axi_offset, vadd_bw
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi2axil_0, and set properties
  set block_name axi2axil
  set block_cell_name axi2axil_0
  if { [catch {set axi2axil_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi2axil_0 eq "" } {
  ...
  if { [catch {set axi_offset_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.INC_M_ADDR {0x0000000000000020} $axi_offset_0


  # Create instance: axi_offset_1, and set properties
  set block_name axi_offset
  set block_cell_name axi_offset_1
  if { [catch {set axi_offset_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_offset_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.INC_M_ADDR {0x0000000000000020} $axi_offset_1
...
\
  ...
  connect_bd_intf_net -intf_net axi2axil_0_m_axi [get_bd_intf_pins axi2axil_0/m_axi] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_offset_0_m_axi_gmem [get_bd_intf_pins axi_offset_0/m_axi_rmem0] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net axi_offset_1_m_axi_gmem [get_bd_intf_pins axi_offset_1/m_axi_rmem0] [get_bd_intf_pins axi_smc/S01_AXI]
  ...
  connect_bd_intf_net -intf_net vadd_bw_0_m_axi_rmem0 [get_bd_intf_pins axi_offset_0/s_axi_rmem0] [get_bd_intf_pins vadd_bw_0/m_axi_rmem0]
  connect_bd_intf_net -intf_net vadd_bw_0_m_axi_wmem0 [get_bd_intf_pins axi_offset_1/s_axi_rmem0] [get_bd_intf_pins vadd_bw_0/m_axi_wmem0]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins axi2axil_0/s_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net rst_ps8_0_100M_interconnect_aresetn [get_bd_pins axi2axil_0/aresetn] [get_bd_pins rst_ps8_0_100M/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_offset_0/ap_rst_n] [get_bd_pins axi_offset_1/ap_rst_n] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins vadd_bw_0/ap_rst_n]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi2axil_0/aclk] [get_bd_pins axi_offset_0/ap_clk] [get_bd_pins axi_offset_1/ap_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins vadd_bw_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi2axil_0/m_axi] [get_bd_addr_segs vadd_bw_0/s_axi_control/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_offset_0/m_axi_rmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_offset_0/m_axi_rmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_offset_1/m_axi_rmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_offset_1/m_axi_rmem0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vadd_bw_0/m_axi_rmem0] [get_bd_addr_segs axi_offset_0/s_axi_rmem0/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vadd_bw_0/m_axi_wmem0] [get_bd_addr_segs axi_offset_1/s_axi_rmem0/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi2axil_0/s_axi/reg0] -force
