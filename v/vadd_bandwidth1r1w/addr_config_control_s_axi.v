...
// ==============================================================
`timescale 1ns/1ps
module addr_config_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_RMEM1_DATA_0 = 6'h1c,
    ADDR_RMEM1_DATA_1 = 6'h20,
    ADDR_RMEM1_CTRL   = 6'h24,
    ADDR_N_DATA_0     = 6'h28,
    ADDR_N_DATA_1     = 6'h2c,
    ADDR_N_CTRL       = 6'h30,
    WRIDLE            = 2'd0,
